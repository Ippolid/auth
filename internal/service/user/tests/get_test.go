...
func TestGet(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			cacheMock: func(mc *minimock.Controller) repository.CacheInterface {
				mock := repoMocks.NewCacheInterfaceMock(mc)
				mock.GetMock.Expect(minimock.AnyContext, id).Return(expectedUser, nil)
				return mock
			},
		},
		{
			...
			userRepositoryMock: func(mc *minimock.Controller) repository.UserRepository {
				mock := repoMocks.NewUserRepositoryMock(mc)
				mock.GetUserMock.Expect(minimock.AnyContext, id).Return(nil, repoErr)
				return mock
			},
			txManagerMock: func(mc *minimock.Controller) db.TxManager {
				mock := mocks.NewTxManagerMock(mc)
			...
			cacheMock: func(mc *minimock.Controller) repository.CacheInterface {
				mock := repoMocks.NewCacheInterfaceMock(mc)
				mock.GetMock.Expect(minimock.AnyContext, id).Return(nil, model.ErrUserNotFound)
				return mock
			},
		},
		{
			...
			cacheMock: func(mc *minimock.Controller) repository.CacheInterface {
				mock := repoMocks.NewCacheInterfaceMock(mc)
				mock.GetMock.Expect(minimock.AnyContext, id).Return(nil, repoErr)
				return mock
			},
		},
	}
