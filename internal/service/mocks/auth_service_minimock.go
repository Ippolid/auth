...
//go:generate minimock -i github.com/Ippolid/auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mocks
...
func (mmCreate *mAuthServiceMockCreate) ExpectInfoParam2(info *model.User) *mAuthServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (mmUpdate *mAuthServiceMockUpdate) Expect(ctx context.Context, id int64, info *model.UserInfo) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) ExpectInfoParam3(info *model.UserInfo) *mAuthServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mAuthServiceMockUpdate) Inspect(f func(ctx context.Context, id int64, info *model.UserInfo)) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) Set(f func(ctx context.Context, id int64, info *model.UserInfo) (err error)) *AuthServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthServiceMockUpdate) When(ctx context.Context, id int64, info *model.UserInfo) *AuthServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *AuthServiceMock) Update(ctx context.Context, id int64, info *model.UserInfo) (err error) {
